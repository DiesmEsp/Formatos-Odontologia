...
public class PacienteService {
    ...
    public int crear(String nombres, String apellidos, int clinicaID) throws SQLException {
        ...
        for (Paciente p : repository.findAll(clinicaID)) {
    ...
    public void actualizar(Paciente paciente) throws SQLException {
        ...
        for (Paciente p : repository.findAll(paciente.getClinicaID())) {
