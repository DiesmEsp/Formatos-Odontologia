-- ============================================================
-- V2__seed.sql
-- Datos de seed / carga inicial
-- Catalogo completo de materiales predefinidos.
-- Docentes, operadores y pacientes se crean en el uso (vacios).
-- ============================================================

-- ------------------------------------------------------------
-- Materiales (Nombre UNIQUE)
-- ------------------------------------------------------------
