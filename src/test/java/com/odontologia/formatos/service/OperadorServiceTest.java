...
class OperadorServiceTest extends BaseRepositoryTest {
    ...
    void crearOperadorValido() throws SQLException {
        int id = service.crear("Ana", "Perez", "12345678", "PRE", "4", 2026, 1);
        assertTrue(id > 0);
    }

    @Test
    void rechazaCombinacionInvalida() {
        assertThrows(NegocioException.class, () -> service.crear("Ana", "Perez", "12345678", "PRE", "R1", 2026, 1));
    }

    @Test
    void rechazaGradoInvalido() {
        assertThrows(NegocioException.class, () -> service.crear("Ana", "Perez", "12345678", "DR", "4", 2026, 1));
    }

    @Test
    void aceptaPosR1() throws SQLException {
        int id = service.crear("Luis", "Gomez", "87654321", "POS", "R1", 2026, 1);
        assertTrue(id > 0);
    }
}
